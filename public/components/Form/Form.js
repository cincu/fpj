  ...
  return (
    ...
    >
      ...
      <p>
        ...
        fill and submit the appointment request form. Any submitted form without
        having a corresponding payment reference will be disregarded.
      </p>
      <fieldset>
      ...
      <p>
        Fill out this as explicit as possible. Seperate queries via e-mail will
        not be responded.
      </p>
      <fieldset
        style={{
      ...
      <label for="tos">
        ...
        <Link href="./terms-and-conditions">terms and conditions</Link> (i would
        be very grateful if you actually read)
      </label>
