export default function termsAndConditionsPage() {
  return (
    <div className="container">
      ...
      Client Health: Clients must disclose any health conditions, allergies, or
      medications that may affect the tattoo process. We prioritize your safety
      and well-being.
      ...
      <h3>Communication</h3> Email Communication: For scheduling, inquiries, and
      ...
      review and approve the final design before the tattooing process begins.
      Payment: Pricing: Tattoo prices are based on size, complexity, and
      ...
      prioritize your health, safety, and satisfaction throughout the tattooing
      process. If you have any questions or concerns, please feel free to
